...
- Single SP equilibrium calculation
...
# Now solve SP problem with the same entropy and pressure
solver.solve(solution, cea.SP, entropy/cea.R, pressure, weights)

if not solution.converged:
    print("ERROR: SP solution did not converge")
    exit(1)
...
# Get analytic derivatives (for SP: state1=S, state2=P)
...
print(f"dH/dS (analytic)       : {dH_dS_analytic:.6e} kJ/kg/(kJ/kg-K) = K")
...
fig1.suptitle('Enthalpy Derivative Convergence (SP Problem)', fontsize=14, fontweight='bold')
...
fig2.suptitle('Temperature Derivative Convergence (SP Problem)', fontsize=14, fontweight='bold')
...
axes2[1].loglog(h_values, errors_dT_dP, 'o-', linewidth=2, markersize=4, label='Error')
axes2[1].axvline(h_values[opt_idx_dT_dP], color='r', linestyle='--', alpha=0.7, linewidth=1.5, label=f'Optimal h={h_values[opt_idx_dT_dP]:.1e}')
axes2[1].set_xlabel('Step size h', fontsize=11)
axes2[1].set_ylabel('Relative error', fontsize=11)
axes2[1].set_title('∂T/∂P', fontsize=12)
...
fig3.suptitle('Species Concentration Derivative Convergence (SP Problem)', fontsize=14, fontweight='bold')
...
# Save figures
fig1.savefig('sp_enthalpy_derivative_convergence.pdf', dpi=300, bbox_inches='tight')
fig2.savefig('sp_temperature_derivative_convergence.pdf', dpi=300, bbox_inches='tight')
fig3.savefig('sp_species_derivative_convergence.pdf', dpi=300, bbox_inches='tight')

print("\n" + "=" * 70)
print("FIGURES SAVED")
print("=" * 70)
print("  - sp_enthalpy_derivative_convergence.pdf")
print("  - sp_temperature_derivative_convergence.pdf")
print("  - sp_species_derivative_convergence.pdf")
print("\n" + "=" * 70)
print("SP derivatives demonstration complete!")
print("=" * 70)
